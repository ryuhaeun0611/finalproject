...
st.markdown("""
이 앱은 숲가꾸기 활동뿐 아니라 수종 구성, 수관 밀도, 경사 지형, 임분 밀도, 습도 등 
다양한 변수가 산불 피해 면적에 어떤 영향을 줄 수 있는지를 시뮬레이션합니다.

사용자 입력에 따라 다중 회귀 및 랜덤포레스트 모델이 예측하며, 
SHAP 분석을 통해 변수의 영향력도 시각화합니다.
""")
...
# 특징 및 타겟 설정
features = ['forest_care_area', 'canopy_density', 'species_type',
...
# Tree 모델이므로 TreeExplainer를 명시적으로 사용해도 됨
